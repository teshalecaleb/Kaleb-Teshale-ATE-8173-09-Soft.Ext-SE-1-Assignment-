<?php
    ...
    if (isset($_POST['submit'])){
        $contact= new Add_post(); // Instantiate the class
        ...
        $query = "INSERT INTO posts(title, body, autor, email, phone) VALUES('$title', '$body', '$autor', '$email', '$phone')";
